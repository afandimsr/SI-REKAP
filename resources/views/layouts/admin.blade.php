...
<html>
    <head>
        ...
        <title> @yield('title') | SI REKAP</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">@yield('title_bar')</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-2020 <a href="http://disdik.semarangkota.go.id/v15/">Dinas Pendidikan Kota Semarang</a>.</strong>
        All rights reserved.
